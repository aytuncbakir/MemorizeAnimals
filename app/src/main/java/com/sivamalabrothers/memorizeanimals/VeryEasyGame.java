...
public class VeryEasyGame extends AppCompatActivity implements TextToSpeech.OnInitListener,
        View.OnClickListener,Animation.AnimationListener{

    TextToSpeech textToSpeech;
    ImageView image1, image2, image3, image4;
    ImageView imageBir, imageIki;
    ...
    int oyunBittiMi = 0;
    TextView tebrikText, rekorText ;
    ImageButton levelAtla;
    LinearLayout tahta;
    ...
    TextView skor,levelGoster,skorText;
    static int skore = 0;
    ...
    String sonSkor = "skor";
    String maksSkor = "maxSkor";
    String sonLevel = "level";
    MediaPlayer ses;
    ...
    private static final int CUSTOM_DIALOG_ID_VERY_EASY_BACK = 0;
    private static final int CUSTOM_DIALOG_ID_VERY_EASY_NEXT = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_very_easy);
  ...
  /*@Override
    ...
    private void init(){
        ...
        //Toast.makeText(context," İnit Level "+level,Toast.LENGTH_LONG).show();

        maxSkor = sharePreferences.getInt(context,maksSkor);
        skore = sharePreferences.getInt(context,sonSkor);
        ...
        String formattedLevel = levelLanguage+ String.valueOf(sharePreferences.getInt(context, sonLevel) / 2 + 1);
    ...
    public void onAnimationEnd(Animation animType) {
        ...
        if(animType.equals(fadeIn) || animType.equals(fadeOut)) {
            ...
            skore += 1;
            skor.setText(String.valueOf(skore));
            if (durum < puan) {
                skor.startAnimation(fadeIn);
                skor.startAnimation(fadeOut);
            } else {
       ...
       // Toast.makeText(context, s, Toast.LENGTH_SHORT).show();
        ...
        for(int i = 0; i<yerlesimBelirle.size(); i++){
            if(yerlesimBelirle.get(i) == 1)
                animalsKonumla.add(animals.get(level));
            else if(yerlesimBelirle.get(i) == 2)
                animalsKonumla.add(animals.get(level+1));
        }
    }
...
/*
            ...
            tebrikText.setTextSize(16);
            params.setMargins(10,10,10,10);
            params.gravity = Gravity.CENTER;
            tebrikText.setLayoutParams(params);
            tebrikText.setTextColor(getResources().getColor(R.color.colorWhite));
            tebrikText.setBackgroundResource(R.drawable.custom_button_tasarim_normal5);
            tebrikText.setTypeface(font, Typeface.BOLD);
            tebrikText.setBackgroundColor(backColourCodeSecond);



            levelAtla = new ImageButton(context);
            levelAtla.setImageResource(R.mipmap.play_button);
            levelAtla.setBackgroundColor(backColourCodeSecond);
            levelAtla.setBackgroundResource(R.drawable.custom_play_button);
            ...
            imageBir.setBackgroundResource(animals.get(level).getImage());
            final TextView textBir = new TextView(context);
            textBir.setLayoutParams(params2);
            textBir.setTextColor(getResources().getColor(R.color.colorAccent));
            textBir.setText(animals.get(level).getName());
            textBir.setTextSize(20);
            textBir.setTypeface(font, Typeface.BOLD);


            imageIki = new ImageView(context);
            imageIki.setLayoutParams(params1);
            imageIki.setBackgroundResource(animals.get(level+1).getImage());

            final TextView textIki = new TextView(context);
            textIki.setLayoutParams(params2);
            textIki.setTextColor(getResources().getColor(R.color.colorAccent));
            textIki.setText(animals.get(level+1).getName());
            textIki.setTextSize(20);
            textIki.setTypeface(font, Typeface.BOLD);
            ...
            */
            ...
            play_next.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    /*
                    tahta.removeView(tebrikText);
                    tahta.removeView(imageBir);
                    tahta.removeView(textBir);
                    tahta.removeView(imageIki);
                    tahta.removeView(textIki);
                    tahta.removeView(levelAtla);
                    ...
                    */
                    ...
                    maksimumRekoruAyarla();
                    // rekoru kaydet
                    sharePreferences.saveInt(context,sonSkor,skore);
                    sharePreferences.saveInt(context,sonLevel,level);
            ...
            look_back.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    showDialog(CUSTOM_DIALOG_ID_VERY_EASY_BACK);
                }
            });
            ...
            look_forward.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    showDialog(CUSTOM_DIALOG_ID_VERY_EASY_NEXT);
                }
            });
    ...
    private void tekrarBaslat(){
        ...
        Intent  intent = new Intent(context, VeryEasyGame.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(intent);
    ...
    protected Dialog onCreateDialog(int id) {
        switch (id){
            case CUSTOM_DIALOG_ID_VERY_EASY_BACK:
                ...
                AnimalCustomAdapter girisMenuCustomAdapter =
                        new AnimalCustomAdapter(this,AnimalMenuItem.getAnimalMenuItems(level,0, animals,0));
        ...
        recyclerView.setLayoutManager(gridLayoutManager);  */
            ...
            case CUSTOM_DIALOG_ID_VERY_EASY_NEXT:
                ...
                AnimalCustomAdapter girisMenuCustomAdapter1 =
                        new AnimalCustomAdapter(this,AnimalMenuItem.getAnimalMenuItems(level,1, animals,0));
